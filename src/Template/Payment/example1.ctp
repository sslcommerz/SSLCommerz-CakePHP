...
if (!Configure::read('debug')) :
    throw new NotFoundException(
        'Please replace src/Template/Pages/example1.ctp with your own version or re-enable debug mode.'
    );
endif;
...
<head>
    ...
    <title>Example - Hosted Checkout</title>
...
<!--        <img class="d-block mx-auto mb-4" src="/docs/4.3/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">-->
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="/pay" method="POST" class="needs-validation">
                <div class="row">
