...
define("SSLCZ_STORE_ID", "testbox"); // Store ID
define("SSLCZ_STORE_PASSWD", "qwerty");// Store Password

# IF SANDBOX TRUE, THEN IT WILL CONNECT WITH SSLCOMMERZ SANDBOX (TEST) SYSTEM
define("SSLCZ_IS_SANDBOX", true); // Sandbox or Live Environment


class SSLCommerzComponent  extends Component
{
